...
# BFS flood fill to remove the light-gray studio background
...
while head < len(queue):
    ...
    # Background is generally R, G, B > 200
...
# Save as white-ertiga.png in public folder
img.save("public/white-ertiga.png")
print("Saved clean, realistic left-facing Ertiga to public/white-ertiga.png")
