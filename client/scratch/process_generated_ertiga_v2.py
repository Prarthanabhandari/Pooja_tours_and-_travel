...
def remove_background(img):
    ...
    while head < len(queue):
        ...
        # The background is neutral gray with color value < 205.
        # The white car body is bright white with color value > 215.
        # This strict threshold prevents bleeding into the car body.
        is_gray = abs(r - g) < 12 and abs(g - b) < 12 and abs(r - b) < 12
        if is_gray and r < 205:
            is_bg[cx][cy] = True
