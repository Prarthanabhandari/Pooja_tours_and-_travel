...
def get_baseline(x):
    # Front bumper goes down to Y=556 at its lowest points (wheel arch curve)
    if x < 400:
        return 556
    elif x < 540:
...
for x in range(width):
    ...
    for y in range(height - 1, baseline - 1, -1):
        ...
        if a > 0:
            # If we hit a dark tire/underbody pixel, stop scanning this column
...
img.save("scratch/test_no_puddle5.png")
print("Saved scratch/test_no_puddle5.png")
